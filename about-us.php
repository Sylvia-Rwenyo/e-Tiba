...
<body class="home">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="images/vitals.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Track your health status</h5>
        <p>Log in how you feel at any time</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="images/medicine.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Be on top of your medication intake</h5>
        <p>Reminders are autoscheduled for you</p>
      </div>
    </div>
  </div>
  <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
