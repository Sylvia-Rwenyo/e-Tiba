        ...
        <div class="all_message_mini">
            ...
            {  
                if($current_user_email == $row["sent_to"])
                {
                    ...
                    { ?>
                        <div class="message-box tri-right-left-top" style="<?php if($current_user_email == $row["emailAddress"]){echo 'text-align:right;margin-left:40%;margin-right:20%;';}else{echo  'text-align:left;margin-right:40%;margin-left:20%;';}?>">
                ...
                {
                    ?>
                        <div class="message-box tri-right-right-top" style="<?php if($current_user_email == $row["emailAddress"]){echo 'text-align:right;margin-left:40%;margin-right:20%;';}else{echo  'text-align:left;margin-right:40%;margin-left:20%;';}?>">
                            <p><?php echo $row["message"]; ?></p>
